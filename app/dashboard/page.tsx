          ...
          <div className="lg:col-span-2">
            <Card>
              ...
              <CardContent className="space-y-6">
                <div className="text-center p-6 bg-gradient-to-br from-primary/5 to-blue-500/5 rounded-lg">
                  <Share2 className="h-12 w-12 text-primary mx-auto mb-4" />
                  <h3 className="text-lg font-semibold mb-2">Share ZENITH with Friends</h3>
                  <p className="text-sm text-muted-foreground mb-4">
                    Earn 3% of every deposit made by friends you refer. No limits on earnings!
                  </p>
                  <div className="text-2xl font-bold text-green-600 mb-2">${referralEarnings.toFixed(2)} earned</div>
                ...
                <div className="space-y-3">
                  <Label htmlFor="referral-link">Your Personal Referral Link</Label>
                ...
                <div className="grid grid-cols-2 gap-4 pt-4">
                  ...
                  <div className="text-center p-4 border rounded-lg">
                    ...
                    <div className="text-sm text-muted-foreground">Total Earned (3%)</div>
                  </div>
                </div>
              </CardContent>
            </Card>
                  ...
                  {recentActivity.slice(0, 4).map((activity, index) => (
                    <div key={index} className="flex items-center justify-between text-sm">
                      <div className="flex items-center space-x-2">
                        ...
                        {activity.type === "referral" && <Users className="h-3 w-3 text-purple-500" />}
                        ...
                        <span>{activity.type === "referral" ? activity.name : activity.symbol}</span>
                      </div>
